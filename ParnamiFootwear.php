...
<body > 
    ...
    <div class="container">
        <div class="navbar">
            ...
            <a href="product.php"><img src="image/cart.png" class="im" style="margin-right: 20px;"></a>
...
<div class="singleproduct">
    <div class="row">
        <div class="col-2">
            <a href="Gleneagles.php"> <img src="image/10.jpg" alt=""></a>
        ...
        <div class="col-2">
            ...
            <br>
            <p>GLENEAGLES MENS UK Size 8 CHESTNUT BROWN SOFT LEATHER SMART ANKLE<br></p>
        </div>
    </div>
</div>
<!--------------title-->

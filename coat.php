...
<div class="singleproduct">
    <div class="row">
        <div class="col-2">
            <a href="coat.php"><img src="image/17.jpg" alt=""></a>
        ...
        <div class="col-2">
            <p>electronics</p>
            <h1>black long coat-show your style</h1>
            <h4>$80.00</h4>
            <select name="" id="">
            ...
            <br>
            <p>Samsung - 50" Class 7 Series LED 4K UHD Smart Tizen TV · <br>TV · LG - 43" Class UN7000 Series LED 4K UHD Smart webOS TV.<br></p>
        </div>
    </div>
</div>
<!--------------title-->

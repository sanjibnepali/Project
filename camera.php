...
<div class="singleproduct">
    <div class="row">
        <div class="col-2">
            <a href="camera.php"><img src="image/16.jpg" alt=""></a>
        ...
        <div class="col-2">
            <p>electronics</p>
            <h1>Camera Nikon</h1>
            <h4>$303.02-$1731.54</h4>
            <select name="" id="">
                <option value="">select type</option>
                <option value="">D7500</option>
                <option value="">D500</option>
                <option value="">D810</option>
                <option value="">D5300</option>
            ...
            <br>
            <p> The Nikon Z 5 mirrorless camera is tough, light, <br>easy to handle, and compatible with a<br> wide array of full-frame lenses.<br></p>
        </div>
    </div>
</div>
<!--------------title-->

        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <h5>
                        <center>Are you sure to delete <strong><?php echo ucwords($drow['username']); ?></strong> from the list? This method cannot be undone.</center>
                    </h5>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-window-close"></i> Cancel</button>
                <a href="delete_user.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete</a>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <div class="container-fluid">
                    <form method="POST" action="admin_edit_user.php?id=<?php echo $erow['id']; ?>">
                        <div class="row">
                            <div class="row">
                                <div class="col-md-12">
